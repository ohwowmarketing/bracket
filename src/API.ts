...
export type UpdateOfficialResultInput = {
  id: string
  superBowl?: Team | string
  tieBreaker?: number | string
  afcConference?: Team | string
  nfcConference?: Team | string
  afcDivisional1?: Team | string
  afcDivisional2?: Team | string
  nfcDivisional1?: Team | string
  nfcDivisional2?: Team | string
  afcWildCard1?: Team | string
  afcWildCard2?: Team | string
  afcWildCard3?: Team | string
  nfcWildCard1?: Team | string
  nfcWildCard2?: Team | string
  nfcWildCard3?: Team | string
  _version?: number | null
}
