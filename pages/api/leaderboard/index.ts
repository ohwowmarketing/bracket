...
const getPoints = async ({ entry, officialResult }) => {
  let points = 0
  points += game(entry.superBowl, officialResult.superBowl, 8)
  points += game(entry.afcConference, officialResult.afcConference, 4)
  points += game(entry.nfcConference, officialResult.nfcConference, 4)
  points += game(entry.afcDivisional1, officialResult.afcDivisional1, 2)
  points += game(entry.afcDivisional2, officialResult.afcDivisional2, 2)
  points += game(entry.nfcDivisional1, officialResult.nfcDivisional1, 2)
  points += game(entry.nfcDivisional2, officialResult.nfcDivisional2, 2)
  points += game(entry.afcWildCard1, officialResult.afcWildCard1, 1)
  points += game(entry.afcWildCard2, officialResult.afcWildCard2, 1)
  points += game(entry.afcWildCard3, officialResult.afcWildCard3, 1)
  points += game(entry.nfcWildCard1, officialResult.nfcWildCard1, 1)
  points += game(entry.nfcWildCard2, officialResult.nfcWildCard2, 1)
  points += game(entry.nfcWildCard3, officialResult.nfcWildCard3, 1)
  return points
}
